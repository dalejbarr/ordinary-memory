...
#+CAPTION: Sensitivity plot for Experiment 1; assumed effect size on the horizontal axis, roportion of simulated datasets showing a significant effect on the vertical axis.
#+LABEL: fig:exp1-sens
...
How sensitive was our experiment to rejecting a null effect of the critical /Distortion/ variable? To address this question, we ran a (post-hoc) sensitivity analysis based on the parameter estimates obtained from the linear mixed-effects analysis. 
